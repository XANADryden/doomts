...
//stati const char rcsid[] = "$Id: d_main.c,v 1.8 1997/02/03 22:45:09 b1 Exp $";

const BGCOLOR :bigint = 7;
const FGCOLOR :bigint = 8;
...
import "hu_stuff.h.ts";
import "wi_stuff.h.ts";
...
declare function D_CheckNetGame () :void;
declare function D_ProcessEvents () :void;
declare function G_BuildTiccmd (cmd :ticcmd_t) :void;
declare function D_DoAdvanceDemo () :void;
...
//
function D_PostEvent (ev :event_t) :void
{
    events[eventhead] = ev;
...
globalThis.setsizeneeded :boolean;
